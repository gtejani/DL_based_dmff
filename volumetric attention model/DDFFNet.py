...
class DDFFNet(nn.Module):
    def __init__(self, focal_stack_size, output_dims=1, cc1_enabled=False, cc2_enabled=False, cc3_enabled=True, cc4_enabled=False, cc5_enabled=False, bias=False, pretrained='no_bn'):
        ...
        self.autoencoder = DDFFAutoEncoder(output_dims, cc1_enabled, cc2_enabled, cc3_enabled, cc4_enabled, cc5_enabled, bias=bias, use_volumetric=True)
...
class DDFFAutoEncoder(nn.Module):
    ...
    def __init__(self, output_dims, cc1_enabled, cc2_enabled, cc3_enabled, cc4_enabled, cc5_enabled, bias=False, use_volumetric=False):
        ...
        if use_volumetric:
            self.volumetric_1 = CBAM()
            self.volumetric_2 = CBAM()
            self.volumetric_3 = CBAM()
            self.volumetric_4 = CBAM()
            self.volumetric_5 = CBAM()
            self.volumetric_6 = CBAM()
        else:
            self.volumetric_1 = None
            self.volumetric_2 = None
            self.volumetric_3 = None
            self.volumetric_4 = None
            self.volumetric_5 = None
            self.volumetric_6 = None
    ...
    def forward(self, x):
        ...
        if not self.volumetric_1 is None:
            x = self.volumetric_1(x)
        ...
        if not self.volumetric_2 is None:
            x = self.volumetric_2(x)
        ...
        if not self.volumetric_3 is None:
            x = self.volumetric_3(x)
        ...
        if not self.volumetric_4 is None:
            x = self.volumetric_4(x)
        ...
        if not self.volumetric_5 is None:
            x = self.volumetric_5(x)
        ...
        if not self.volumetric_6 is None:
            x = self.volumetric_6(x)
